...
void XPUActivityProfilerSession::removeCorrelatedPtiActivities(const itrace_t* act1) {
...
// from PTI
inline int64_t XPUActivityProfilerSession::getMappedQueueId(
...
void XPUActivityProfilerSession::handleKernelActivity(
  ...
  kernel_activity->device =
      c10::xpu::get_device_idx_from_uuid(activity->_device_uuid);
