...
class PythonProfilerEventHandler(cpp.ProfilerEventHandler):
    ...
    def emulateTraining(self, iteration: int, thread_id: int) -> None:
        ...
        sync_func = getattr(torch, device).synchronize
...
# Here duplicate the CppThreadTestXPU to enable the xpu cases because
# the instantiate_device_type_tests will call setUp to launch the threads
# unexpectedly
