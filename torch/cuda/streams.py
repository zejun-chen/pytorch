...
import torch
from torch.device_interface import DeviceInterface
...
class Stream(torch._C._CudaStreamBase, DeviceInterface.Stream):
...
class Event(torch._C._CudaEventBase, DeviceInterface.Event):
