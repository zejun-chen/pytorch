...
class StreamContextVariable(ContextWrappingVariable):
    ...
    def create(tx, target_value, **kwargs):
        ...
        current_stream_function = device_functions[
            target_value.device
        ].current_stream_func
    ...
    def __init__(self, target_values, device, initial_values=None, **kwargs):
        ...
        self.device = device
        self.set_stream_func = device_functions[self.device].set_stream_func
    ...
    def enter(self, tx):
        ...
        # stream passed from outside of traced function
            ...
            tx.output.create_proxy(
                "call_function",
                device_functions[self.device].set_stream_by_id_func,
